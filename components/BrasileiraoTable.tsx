...
const BlueskyIcon = () => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 fill-current"><title>Bluesky</title><path d="M19.98 6.01a6.44 6.44 0 0 0-10.2-5.24 6.44 6.44 0 0 0-6.22 8.46 6.44 6.44 0 0 0 10.2 5.24 6.44 6.44 0 0 0 6.22-8.46Z"/></svg>
);
