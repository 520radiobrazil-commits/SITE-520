...
export const MOCK_ARTICLES: Article[] = [
  {
    ...
    title: 'Giants Secure Dramatic Last-Minute Victory Over Eagles',
    summary: 'A thrilling conclusion at MetLife Stadium saw the Giants clinch a 24-21 win with a field goal as time expired.',
    content: 'In a game that will be remembered for its back-and-forth action, the New York Giants triumphed over the Philadelphia Eagles. The final quarter was a masterclass in tension, with both teams exchanging touchdowns. Ultimately, it came down to the final drive, where the Giants\' offense meticulously marched down the field, setting up their kicker for a game-winning 45-yard field goal. The crowd erupted as the ball sailed through the uprights, marking a significant win for the home team.',
    imageUrl: 'https://picsum.photos/seed/football1/800/600',
  ...
  },
  {
    ...
    title: 'Lakers Outlast Celtics in Overtime Thriller',
    summary: 'LeBron James scores 40 points to lead the Lakers to a hard-fought 128-124 victory against their historic rivals.',
    content: 'The age-old rivalry between the Lakers and Celtics added another classic chapter tonight. LeBron James was unstoppable, pouring in 40 points, grabbing 10 rebounds, and dishing out 9 assists. The game went into overtime after a nail-biting fourth quarter. In the extra period, the Lakers\' experience shone through, as they made crucial defensive stops and hit their free throws to seal the win.',
  ...
  },
  {
    id: 4,
    category: 'Podcast',
    title: 'The State of Modern Athletics',
    summary: 'Special guest Dr. Eva Rostova discusses the impact of technology and data analytics in today\'s sports.',
    content: 'In this week\'s episode, we sit down with sports scientist Dr. Eva Rostova. We explore how teams are leveraging advanced data analytics to gain a competitive edge, from player recruitment to in-game strategy. Dr. Rostova also sheds light on the latest wearable technology and how it is revolutionizing athlete training and injury prevention. A must-listen for any serious sports fan.',
  ...
  },
  {
    ...
    summary: 'A Conmebol confirmou que a final da Libertadores será em Lima, ignorando um pedido da CBF para transferir o jogo entre Palmeiras e Flamengo para o Brasil.',
    content: `A Conmebol confirmou, nesta quinta-feira (31), que a final da Copa Libertadores da América 2025 será mantida em Lima, no Estádio Monumental “U”, no dia 29 de novembro. A entidade reiterou que não pretende alterar a sede da decisão, mesmo após o presidente da CBF, Samir Xaud, sugerir a possibilidade de levar o confronto entre Palmeiras e Flamengo para o Brasil.

A ideia de Xaud surgiu após o Palmeiras garantir vaga na decisão ao golear a LDU por 4 a 0, no Allianz Parque. O dirigente brasileiro se mostrou disposto a intermediar um pedido dos clubes para que a final fosse disputada em território nacional, mas a proposta não avançou.

De acordo com a Conmebol, toda a estrutura para o evento já está definida. Hospedagens, centros de treinamento e o esquema logístico de transporte das delegações estão prontos. Além disso, os representantes dos quatro semifinalistas — Palmeiras, Flamengo, LDU e River Plate — foram informados sobre a escolha de Lima ainda durante uma reunião em Luque, no Paraguai, antes da definição dos finalistas.

A postura da confederação reforça a estratégia de manter o formato de final única e de não ceder a pressões locais, uma política que vem sendo defendida pelo presidente Alejandro Domínguez. O modelo, inspirado na UEFA Champions League, é considerado pela Conmebol como essencial para valorizar o produto e ampliar a visibilidade comercial do torneio, ainda que gere polêmicas logísticas e críticas de torcedores.

Análise: decisão política e simbólica

A manutenção da sede em Lima vai além da questão operacional — ela representa um gesto político da Conmebol. A entidade buscou evitar precedentes que pudessem abrir espaço para pedidos futuros de mudança, especialmente de países com clubes influentes como Brasil e Argentina.

Para os clubes brasileiros, a decisão impõe desafios práticos. O deslocamento de torcidas, custos de viagem e limitação de ingressos são temas sensíveis, principalmente diante da rivalidade entre Palmeiras e Flamengo, que promete mobilizar multidões.
